...
setNames(aggregate(heart_health_metrics$HeartDisease ~ heart_health_metrics$ST_Slope, FUN = mean), c("ECG Wave Type","Heart Disease Risk"))
```
...
setNames(aggregate(heart_health_metrics$HeartDisease ~ heart_health_metrics$ChestPainType, FUN = mean), c("Chest Pain Type","Heart Disease Risk"))
```
